...
// */
//char *array_subrange(a, start, nelem, starsub, quoted)
//	 ARRAY *a;
...
//}
//
///* Convenience routines for the shell to translate to and from the form used by the rest of the code. */
//
...
//}
//
func make_word_list(x *word_desc, l *word_list) *word_list {
	w := new(word_list)
	w.word = x;
	w.next = l;
	return w;
